...
if __name__ == "__main__":
    ...
    df = spark.read.csv("hdfs://localhost/user/cloudera/spark_sql_101/data/stocks_header.txt",
                        inferSchema=True,
                        header=True)
    ...
    df = spark.read.csv("hdfs://localhost/user/cloudera/spark_sql_101/data/contains_null.txt", inferSchema=True, header=True)
